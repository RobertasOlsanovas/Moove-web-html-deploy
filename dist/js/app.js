    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (e.target.closest(".icon-menu")) if (document.documentElement.classList.contains("overflow")) setTimeout((() => {
...
*/
        ...
        const word = () => {
            ...
            Array.from(word.textContent).forEach(((elem, i) => {
                if (" " === elem) out += " "; else out += `<span class="letter-${i}">${elem}</span>`;
            }));
            word.innerHTML = out;
            ...
            for (let i = 0; i < 15; i++) wordLine.fromTo(`.letter-${i}`, {
                opacity: 1,
                y: 0,
                color: "#fff"
            }, {
        ...
        let phoneY;
        if (window.innerWidth > 1630 && window.innerWidth <= 2560) phoneY = "-78%"; else if (window.innerWidth > 1280 && window.innerWidth <= 1630) phoneY = "-77.5%"; else if (window.innerWidth > 992 && window.innerWidth <= 1280) phoneY = "-79.5%"; else if (window.innerWidth > 768 && window.innerWidth <= 992) phoneY = "-79%"; else if (window.innerWidth > 480 && window.innerWidth <= 768) phoneY = "-77%"; else if (window.innerWidth > 290 && window.innerWidth <= 480) phoneY = "-77.3%";
        ...
        window.addEventListener("load", (() => {
            ...
            tl.to(".main__background-color", {
                ...
                duration: 6,
                ease: "circ.in"
            }).from(".main__city-image_1", {
                y: "+100%",
                opacity: 0,
                duration: 3,
                ease: "power1.inOut"
            }, 0).from(".main__city-image_2", {
                y: "+100%",
                opacity: 0,
                duration: 3,
                ease: "power1.inOut"
            }, .5).from(".main__city-image_3", {
                y: "+100%",
                opacity: 0,
                duration: 3,
                ease: "power1.inOut"
            }, 1).from(".main__city-image_4", {
                y: "+100%",
                opacity: 0,
                duration: 2.4,
                ease: "power1.inOut"
            }, "-=6").from(".main__bottom-image", {
                y: "-100%",
                opacity: 0,
                duration: 4,
                ease: "power1.inOut"
            }, 0).from(".main__grass-image", {
                x: "-100%",
                opacity: 0,
                duration: 2.2,
                ease: "power3.out"
                ...
                duration: 3.8,
                onComplete: sport
            }, 4).from(".main__sun-image", {
                y: "+150%",
                duration: 5.4,
                scale: 0,
                rotate: -1080,
                transformOrigin: "center"
            }, 4).to(".main__top-image-2", {
                opacity: 0,
                duration: 4.4,
                ease: "power4.inOut"
            }, 4).to(".main__top-image-2", {
                ...
                duration: 1.2,
                ease: "power1.inOut"
            }, 9.2).from("._sportsman-6", {
                opacity: 0,
                scale: .8,
                rotate: -5,
                duration: 1.2,
                ease: "power1.inOut"
            }, 9.4).from("._sportsman-3", {
                opacity: 0,
                scale: .8,
                rotate: 5,
                duration: 1.2,
                ease: "power1.inOut"
            }, 9.6).from("._sportsman-2", {
                opacity: 0,
                scale: .8,
                rotate: -5,
                duration: 1.2,
                ease: "power1.inOut"
            }, 10).from("._sportsman-1", {
                opacity: 0,
                scale: .8,
                rotate: 5,
                duration: 1.2,
                ease: "power1.inOut"
            }, 9.8).from(".main__title-box", {
                x: "-50%",
                opacity: 0,
                duration: .9,
                ease: "circ.out",
            ...
            globus.from(".app__shape-outside", {
                opacity: 0,
                scale: 0,
                x: gsap_random(-50, 50),
                y: gsap_random(-50, 50),
                ...
                z: gsap_random(-50, 50),
                duration: .5
            }, "-=0.2").from(".app__shape-background", {
                opacity: 0,
                scale: 0,
                x: gsap_random(-50, 50),
                y: gsap_random(-50, 50),
                z: gsap_random(-50, 50),
                duration: .5
            }, "-=0.2").from(".app__shape-outside-lines", {
                opacity: 0,
                scale: 0,
                duration: .5
            }, "-=0.2").from(".app__shape-lines", {
                opacity: 0,
                scale: 0,
                duration: .3
            }, "-=0.1").from(".app__shape-people", {
                opacity: 0,
                scale: 0,
                duration: .6
            }, "-=0.1").to(".app__shape-background-lines", {
                opacity: .6,
                scale: .9,
                duration: .6,
                repeat: -1,
            ...
            gsapWithCSS.to(".app__shape-background", {
                scrollTrigger: {
                    trigger: ".app",
                    start: "top bottom",
                    end: "bottom top",
            ...
            footer.from(".footer__top", {
                ...
                opacity: 0,
                duration: 1
            }, "-=1").from(".footer__shadow", {
                opacity: 0,
                scale: 0,
                duration: 1.2
            }, "-=0.8").from(".footer__inner", {
                scale: 0,
                duration: .8,
                ease: "sine.out"
            }, "-=0.4s");
            ...
            activities.from(".activities__image_1", {
                rotate: -20,
                scale: .8,
                x: "-200%",
                duration: .8
                ...
                duration: .8,
                ease: "power1.out"
            }).from(".activities__image_2", {
                opacity: 0,
                scale: .3,
                duration: .8
            }, "-=0.8").from(".activities__image_3", {
                rotate: 20,
                scale: .8,
                x: "+150%",
                duration: .8
            }, "-=0.8").from(".activities__image-tennis", {
                rotate: 360,
                x: -300,
                y: 200,
                opacity: 0,
                duration: .8,
                ease: "power1.out"
            }).from(".activities__image_4", {
                x: "-400%",
                duration: 1.6,
                ease: "power1.inOut"
            }, "-=0.8").from(".activities__image_5", {
                opacity: 0,
                scale: .3,
                duration: .8
        ...
        if (!isMobile.any()) window.addEventListener("scroll", (() => {
            document.querySelector(".main__title").style.transform = `translateY(${.2 * window.scrollY}px)`;
            document.querySelector(".header").style.transform = `translateY(${.6 * window.scrollY}px)`;
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
